 ...
 *
 */
namespace Piwik\Plugins\OpeniCompanyTracker\Reports;
 ...
 */
class TrackByCompany extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('OpeniCompanyTracker_TrackByCompany');
        $this->dimension     = null;
        ...
        $this->menuTitle    = 'Track By Company';
        ...
        $this->widgetTitle  = 'Track By Company';
    }
...
//        $settings = new \Piwik\Plugins\OpeniCompanyTracker\Settings('OpeniCompanyTracker');
//        $columnToAggregate = $settings->realtimeReportDimension->getValue();
//        $columnLabel = \Piwik\Plugins\OpeniCompanyTracker\OpeniCompanyTracker::$availableDimensionsForAggregation[$columnToAggregate];


        $view->config->addTranslation('label', 'Company');
